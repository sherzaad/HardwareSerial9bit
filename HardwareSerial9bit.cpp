/*
  HardwareSerial9bit.cpp - Hardware serial library for Wiring
...
#include "HardwareSerial9bit_private.h"

// this next line disables the entire HardwareSerial9bit.cpp, 
...
// HardwareSerial9bit instance if the user doesn't also refer to it.
...
void HardwareSerial9bit::_tx_udr_empty_irq(void)
{
...
void HardwareSerial9bit::begin(unsigned long baud, byte config)
{
  // Try u2x mode first
...
int HardwareSerial9bit::available(void)
{
  return ((unsigned int)(SERIAL_RX_BUFFER_SIZE + _rx_buffer_head - _rx_buffer_tail)) % SERIAL_RX_BUFFER_SIZE;
}

int HardwareSerial9bit::peek(void)
{
...
int HardwareSerial9bit::read(void)
{
...
int HardwareSerial9bit::availableForWrite(void)
{
...
size_t HardwareSerial9bit::write(uint16_t n)
{
