...
// HardwareSerial9bit constructor also works, but makes the code bigger and
// slower.
#if !defined(TXC0)
#if defined(TXC)
...
#define UPE PE //Parity Error flag
#endif
...
#define TXB80 TXB8
#define UPE0 UPE
#define FE0 FE //Stop bit Error flag
#define DOR0 DOR //Data Overruun Error flag
#elif defined(TXC1)
...
#define DOR0 DOR1
#else
#error No UART found in HardwareSerial9bit.cpp
#endif
#endif // !defined TXC0
...
HardwareSerial9bit::HardwareSerial9bit(
...
void HardwareSerial9bit::_rx_complete_irq(void)
{	
	
	_rx.bytes[1] = (*_ucsra & 0xFE)|(bit_is_set(*_ucsrb,RXB80)>>RXB80); //put error flags bit and 9th data bit in buffer MSByte (9th bit is bit0 of MSByte)
																		//Bit 4: FE – Frame Error, Bit 3: DOR – Data Overrun Error, Bit 2: PE – Parity Error.
    _rx.bytes[0] = *_udr ; 
